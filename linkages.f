...
C.....
      OPEN(UNIT=5,FILE='settings.txt',ACCESS='SEQUENTIAL',STATUS='OLD')
...
C.....
      READ(5,*) PLAT,PLONG,BGS,EGS,FC,DRY
      TGS = EGS-BGS+1
...
C we fixed this to output csv files
     ...
     1NCOHRT,HCN,BASESC,BASESN,SCO2,TYLN
      COMMON/SPECIE/SPEC(10),BMSPEC
      REAL, DIMENSION(nmax) :: BAR, XSTEM, XTAB, XFL, XTL
      REAL, DIMENSION(nmax) :: XNAP, XAVLN, XCN, XSCO2C, XSOM
      REAL, DIMENSION(nmax) :: XET, NYR, SSTEM, STAB, STL
      REAL, DIMENSION(nmax) :: SNAP, SAVLN, SCN, SSCO2C, SSOM
      REAL, DIMENSION(nmax) :: SET, SFL
      REAL, DIMENSION(nmax,100) :: TSTEM, TAB, FL, TOTL, SOM
      REAL, DIMENSION(nmax,100) :: TNAP, AVLN, CN, SCO2C, ET
      REAL, DIMENSION(nmax,100) :: AVG 
      REAL, DIMENSION(nmax,11) :: CONF
      REAL, DIMENSION(30) :: ST
      REAL, DIMENSION(10,nmax) :: XBMSPE, SSBMSP
      REAL, DIMENSION(nmax,10) :: AVGBM, CONFBM 
      REAL, DIMENSION(10,nmax,100) :: XBAR 
C     DIMENSION BAR(70)
C     DIMENSION TSTEM(70,100),TAB(70,100),FL(70,100),TOTL(70,100)
C     DIMENSION TNAP(70,100),AVLN(70,100),CN(70,100),SCO2C(70,100)
C     DIMENSION SOM(70,100),ET(70,100),XSTEM(70),XTAB(70),XFL(70)
C     DIMENSION XTL(70),XNAP(70),XAVLN(70),XCN(70),XSCO2C(70)
C     DIMENSION XSOM(70),XET(70),NYR(70),AVG(70,11)
C     DIMENSION SSTEM(70),STAB(70),SFL(70),STL(70),SNAP(70)
C     DIMENSION SAVLN(70),SCN(70),SSCO2C(70),SSOM(70),SET(70)
C     DIMENSION CONF(70,11),ST(30)
C     DIMENSION XBMSPE(10,70),SSBMSP(10,70),AVGBM(70,10)
C     DIMENSION CONFBM(70,10),XBAR(10,70,100)
      DIMENSION NFREQ(100), TSBAR(100)
      INTEGER BMSPEC, SPEC
      LOGICAL SWITCH, SWTCH
