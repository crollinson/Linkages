...
C we fixed this to output csv files
     ...
     1NCOHRT,HCN,BASESC,BASESN,SCO2,TYLN
      COMMON/SPECIE/SPEC(10),BMSPEC
      DIMENSION BAR(100)
      DIMENSION TSTEM(70,100),TAB(70,100),FL(70,100),TOTL(70,100)
      DIMENSION TNAP(70,100),AVLN(70,100),CN(70,100),SCO2C(70,100)
      DIMENSION SOM(70,100),ET(70,100),XSTEM(70),XTAB(70),XFL(70)
      DIMENSION XTL(70),XNAP(70),XAVLN(70),XCN(70),XSCO2C(70)
      DIMENSION XSOM(70),XET(70),NYR(70),AVG(70,11)
      DIMENSION SSTEM(70),STAB(70),SFL(70),STL(70),SNAP(70)
      DIMENSION SAVLN(70),SCN(70),SSCO2C(70),SSOM(70),SET(70)
      DIMENSION CONF(70,11),ST(30)
      DIMENSION XBMSPE(10,70),SSBMSP(10,70),AVGBM(70,10)
      DIMENSION CONFBM(70,10),XBAR(10,70,100)
